...
class CONFIGURACOES:
    def __init__(self):
        ...
        self.caminho_banco_dados_programacao = r"C:\Users\manriquef\Documents\AREA_DE_TRABALHO_ESTUDOS_PA\aplication\src\assets\09_04_2026_PROGRAMAÇÃO EB PM_PA_VBA.xlsm"
        """------------------------------------------------------------------------------------------------------------------------------------------"""
